            ...
            <div class="container">
                <div class="col-lg-12">
                    <div class="totle_pic_div">
                    	Total Rep <span class="pic_box"><?=$no_pics_total;?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form action="" method="get">Search Rep: <input value="<?=$_GET['src'];?>" placeholder="Search by Name,Email,Address" size="50" type="text" class="form-control" name="src" /> <input type="submit" value="Search" /></form>
                    </div>
                </div>
                ...
                <div class="col-lg-9">
                    ...
                    ?>
                        <div class="row">
                            <div class="column first">
                        	<input name="checked_ids[]" type="checkbox" value="<?=$row_pics['r_id_key'];?>" />
                        </div>
                            <div class="column middle">
                            <?
                           echo $row_pics['rid'];
                            ...
                            <div class="column left">
                            <a href="admin-manage-rep-edit.php?rid=<?=$row_pics['r_id_key'];?>" target="_blank"><?=$row_pics['rname'];?></a>
