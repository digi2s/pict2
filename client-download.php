                        ...
                        <input type="hidden" name="frm_action" value="client_download" />
                            <div class="col-sm-12">
                              <div class="form-group">
                                ...
                                ?>
                                    <option <?php if($row['sdefault']=="1"){?> selected="" <? } ?> value="<?=$row['rid'];?>"><?=$row_model['rname'];?> - <?=$row['rid'];?></option>
                                   <? } ?>
                                </select>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                              <div class="form-group">
                                ...
                                <input data-validation="required" value="<?=$row1['cdpath'];?>" id="path" name="path" type="text" class="form-control">
