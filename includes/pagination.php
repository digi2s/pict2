...
class Pagination {
  ...
  public function getTags() {
    ...
    if ($this->total_pages > 1) {
      $tags .= "<ul class='rq-pagination rq-pagination-horizontal-list'>";

      // show prev/first links
      if ($this->current_page > 1) {
        $tags .= "<li><a href='" . $this->canonical_url . "?page=" . $this->previous_page . $this->url_params . "'>Previous</a></li>";
        $tags .= "<li><a href='" . $this->canonical_url . "?page=1" . $this->url_params . "'>First</a></li>";
      }

      // page links
      for ($i = $this->start_offset; $i <= $this->end_offset; $i++) {
        if ($i == $this->current_page) {
          $tags .= "<li class='active'><b>$i</b></li>";
        }
        else {
          $tags .= "<li><a href='" . $this->canonical_url . "?page=" . $i . $this->url_params . "'>" . $i . "</a></li>";
        }
      }

      // show last/next links
      if ($this->current_page < $this->total_pages) {
        $tags .= "<li><a href='" . $this->canonical_url . "?page=" . $this->total_pages . $this->url_params . "'>Last</a></li>";
        $tags .= "<li><a href='" . $this->canonical_url . "?page=" . $this->next_page . $this->url_params . "'>Next</a></li>";
      }
