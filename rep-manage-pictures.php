...
<body>
    <div id="wrapper">
        ...
        <div id="main-wrapper">
            ...
            <div class="container">
                <div class="col-lg-12">
                    <div class="totle_pic_div">
                    	Total Pictures <span class="pic_box"><?=$no_pics_total;?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Space Used <span class="pic_box"><?=$size_in_mb;?> Mb</span>
                    </div>
                </div>
                    ...
                    <?php
                            ...
                            while($row_pics = mysqli_fetch_array($rs_pics))
                            {
                              ...
                              /*  $im = imagecreatefromstring($row_pics['pbody']);
                                ...
                                $height = imagesy($im); */
                    ?>
                    <li title="<?=$row_pics['pid'];?>">
                        <div class="row">
                            <div class="column first">
                        	<input name="checked_ids[]" type="checkbox" value="<?=$row_pics['pid'];?>" />
                        </div>
                            <div class="column left">
                            <a href="rep-pics-view.php?pid=<?=$row_pics['pid'];?>" target="_blank"><?=$row_pics['name'];?></a>
                            </div>
                            <div class="column middle">
                            <?
            ...
            <input name="sort_order" id="sort_order" value="<?=$order_val;?>" type="hidden">
    ...
    <form action="action.php" method="post" name="frm_operation">
        ...
        <input name="sort_order_forsave" id="sort_order_forsave" value="<?=$order_val;?>" type="hidden">
