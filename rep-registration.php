            ...
            <div class="container">
                <div class="col-lg-12">
                	<div class="contact_form_div">
                        <form action="rep-registration-confirmation.php" method="post" name="frm_contact" id="frm_contact" onsubmit="return check_contact()">
                    ...
                    <? $_SESSION['rep_reg_msg']=''; } ?>
                           <div class="col-sm-12">
                              <div class="form-group">
                                <label for="fullname">Rep Reg CODE</label>
